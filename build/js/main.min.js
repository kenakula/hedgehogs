...
/* harmony import */ var _modules_card_tooltip__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/card-tooltip */ "./js/modules/card-tooltip.js");
/* harmony import */ var _modules_parallax__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/parallax */ "./js/modules/parallax.js");
/* harmony import */ var _modules_cart__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/cart */ "./js/modules/cart.js");
...
Object(_modules_toggler__WEBPACK_IMPORTED_MODULE_3__["toggler"])();
...
Object(_modules_form_validation__WEBPACK_IMPORTED_MODULE_6__["formsValidation"])();
Object(_modules_card_tooltip__WEBPACK_IMPORTED_MODULE_7__["cardTooltip"])();
Object(_modules_parallax__WEBPACK_IMPORTED_MODULE_8__["parallax"])();
Object(_modules_cart__WEBPACK_IMPORTED_MODULE_9__["cart"])();
...
var cardTooltip = function cardTooltip() {
  var tooltips = document.querySelectorAll('.js-card-tooltip');
  ...
  var Tooltip = /*#__PURE__*/function () {
    ...
    _createClass(Tooltip, [{
      ...
      value: function toggleTooltip(evt) {
        var target = evt.target.closest('.js-card-tooltip-button');
      ...
      key: "addLike",
      value: function addLike(evt) {
        var target = evt.target.closest('.js-like-btn');

        if (target) {
          var likes = +this.likeCount.textContent;
  ...
  tooltips.forEach(function (item) {
    var tooltipInst = new Tooltip(item);
  });
};
...
var cart = function cart() {
  ...
  var Cart = /*#__PURE__*/function () {
    function Cart(el) {
      ...
      this.addToCartButtons.forEach(function (btn) {
        btn.addEventListener('click', _this.addToCart.bind(_this));
      });
    }

    _createClass(Cart, [{
      key: "openCart",
      value: function openCart(evt) {
        var target = evt.target.closest('.js-cart-btn');
      ...
      value: function addToCart(evt) {
        var target = evt.target.closest('.js-add-to-cart');

        if (!target) {
          return;
        }

        var cardItem = target.closest('.card');
        var cardTitle = cardItem.querySelector('.card__title').textContent;
        var cardImgSrc = cardItem.querySelector('.card__img img').getAttribute('src');
        var cardImgSrcset = cardItem.querySelector('.card__img img').getAttribute('srcset');
        var template = this.cartItemTemplate.content.cloneNode(true);
        var newItem = this.setCartItem(cardTitle, cardImgSrc, cardImgSrcset, cardTitle, template);
        this.cartList.appendChild(newItem);
      }
    }, {
      key: "clearItemFromCart",
      value: function clearItemFromCart(evt) {
        var target = evt.target.closest('.cart__delete-btn');

        if (target) {
          var item = target.closest('.cart__item');
          item.remove();
        }
      }
    }, {
      key: "setCartItem",
      value: function setCartItem(name, src, srcset, alt, template) {
        var title = template.querySelector('.cart__item-title');
        var image = template.querySelector('img');
        var cartDeleteBtn = template.querySelector('.cart__delete-btn');
        image.src = src;
        image.srcset = srcset;
        image.alt = alt;
...
/*!***************************************!*\
  !*** ./js/modules/form-validation.js ***!
  \***************************************/
/*! exports provided: formsValidation */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "formsValidation", function() { return formsValidation; });
...
var formsValidation = function formsValidation() {
  ...
  var ValidateForm = /*#__PURE__*/function () {
    ...
    _createClass(ValidateForm, [{
      key: "initTelInputs",
      value: function initTelInputs() {
        var _this = this;

        var telInputs = this.form.querySelectorAll('input[type="tel"]');
        telInputs.forEach(function (telInput) {
          var mask = new imask__WEBPACK_IMPORTED_MODULE_0__["default"](telInput, _this.telMaskOption);
        });
      }
    }, {
      key: "setListeners",
      ...
      key: "validateTelInput",
      value: function validateTelInput(value, message, input) {
        var errMsg = message;
      ...
      value: function validateInput(input) {
        ...
        var message = input.dataset.error;
      ...
      value: function getErrorMessages() {
        ...
        this.errors = [];
        this.inputs.forEach(function (input) {
          var message = _this3.validateInput(input);

          if (message.length) {
            _this3.errors.push(message);
          }
        });
      }
    }, {
      ...
      value: function onFormSubmit(evt) {
        ...
        if (this.errors.length) {
          ...
          evt.preventDefault();
          this.resetForm();
          Object(_utils_modal__WEBPACK_IMPORTED_MODULE_1__["openModal"])(successModal);
        }
      }
    }]);
  ...
  if (forms.length) {
    forms.forEach(function (form) {
      var formInst = new ValidateForm(form);
    });
  }
};
...
var modalSuccess = document.querySelector('.modal--success'); // const modalSuccessBtns = document.querySelectorAll('[data-modal="success"]');
...
var pageScroll = function pageScroll() {
  var scrollableContainer = document.querySelector('.wrapper');

  var scrollPositionHandler = function scrollPositionHandler() {
...
var parallax = function parallax() {
  var promoList = document.querySelector('.js-promo-list');
  var hedgehogs = document.querySelectorAll('.js-hedgehog');
  ...
  var transformEl = function transformEl(x, y, mult, el) {
    el.style.transform = "translate3d(0, ".concat(y * mult, "px, 0)");
  };
...
var slider = function slider() {
  var sliders = document.querySelectorAll('.js-slider-block-container');

  if (sliders.length) {
    sliders.forEach(function (sliderEl) {
      var initSlider = function initSlider() {
        var container = sliderEl.querySelector('.swiper-container');
        var btns = sliderEl.querySelectorAll('.slider-block__button');
...
var toggler = function toggler() {
  var TOGGLER_EXPANDED_CLASS = 'toggler--close';
  var togglerBtn = document.querySelector('.js-toggler');

  if (!togglerBtn) {
    return;
  }

  var toggleMenu = function toggleMenu(btn, nav, navClass) {
  ...
  var onTogglerClickExpandMenu = function onTogglerClickExpandMenu(evt) {
    var target = evt.target.closest('.js-toggler');

    if (target) {
      var menuId = target.dataset.targetId;
      var menuEl = document.querySelector("#".concat(menuId));
      var menuExpandedClass = target.dataset.targetClassToggle;
